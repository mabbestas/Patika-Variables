...
namespace Variables
{
    class Program
    {
        static void Main(string[] args)
        {
            /* KURALLAR --
             * 
             * Program içerisinde kullanılan isimler degişken olarak kullanılmaz.
             * string System = "Bu değişken olamaz"; 
             * Herhangi bir sayı veya rakamla başlayan değişken isimleri kullanılamaz. 
             * Değişken adı hiçbir zaman boşluk içeremez.
             * Boşluk yerine _ kullanılabilir.
            */
